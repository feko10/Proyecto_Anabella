...
class formularioContacto(forms.Form):
    ...
    contenido=forms.CharField(label="Consulta", widget=forms.Textarea) #El textarea es para que el formulario se forme un cuadro de dialgo más amplio para escribir más.
