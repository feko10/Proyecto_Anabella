"""
Django settings for Anabella project.
...
SECRET_KEY = 'django-insecure-qhzz-scw(d=n_(j2$t0#)7&p2yx_%=*gy@i-(9=*8ah%pwsku$'
...
WSGI_APPLICATION = 'Anabella.wsgi.application'
